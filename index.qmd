...
1. Fontes e estrutura dos dados
2. Séries e climatologia meteorológica
3. Integração com dashboard Shiny
4. Padrões temporais hora × dia da semana
5. Influência meteorológica (polar plots / rosas)
6. Mapas de sensores e concentrações médias
7. Estatísticas resumidas (`aqStats`)
8. Anexos (sessão, tabelas WHO / AQI)
